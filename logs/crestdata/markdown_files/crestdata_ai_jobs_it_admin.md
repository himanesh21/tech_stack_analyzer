...
https://crestdata.ai/jobs/it-admin

---

Skip links
  * [ Skip to primary navigation](https://www.crestdata.ai/jobs/it-admin/#primary-nav)
  * [ Skip to content](https://www.crestdata.ai/jobs/it-admin/#lqd-site-content)
...
## Capabilities
![](https://www.crestdata.ai/jobs/it-admin/)
### Product Engineering 
...
## Neuwave AI-native  
Infra Operations
  * [Resources](https://www.crestdata.ai/jobs/it-admin/)
...
[ Learn More  ](https://www.crestdata.ai/case-studies/)
  * [Company](https://www.crestdata.ai/jobs/it-admin/)
...
Toggle navigation [ ![Crest Data](https://www.crestdata.ai/wp-content/uploads/2021/08/gradient_logo.png) ](https://www.crestdata.ai/)
  ...
  * [Solutions](https://www.crestdata.ai/jobs/it-admin/)
    * [Offerings](https://www.crestdata.ai/jobs/it-admin/)
    ...
    * [Domains](https://www.crestdata.ai/jobs/it-admin/)
      * [Security](https://www.crestdata.ai/solutions/security/)
    ...
    * [Platforms](https://www.crestdata.ai/jobs/it-admin/)
  ...
  * [Products](https://www.crestdata.ai/jobs/it-admin/)
    * [Datadog Apps](https://www.crestdata.ai/jobs/it-admin/)
    ...
    * [Security & Observability Migrations](https://www.crestdata.ai/jobs/it-admin/)
...
**Experience** : 3+ Years  
**Job Description** :
  * Install, configure, and troubleshoot Linux servers and applications.
  * Perform log analysis, application troubleshooting, and root cause identification.
  * Manage SSL certificates and endpoint security applications.
  * Deploy and support servers on VMware and cloud platforms (AWS, GCP, Azure).
  * Monitor system performance and resolve issues proactively.
  * Support CI/CD pipeline activities and act as SME for supported systems.


**Requirements**
  * Strong hands-on experience with Linux distributions: Red Hat, CentOS, Ubuntu.
  * Installation, configuration, and troubleshooting of Linux-based servers and applications.
  * Hands-on experience with application-level troubleshooting, log analysis, and root cause identification.
  * Experience with SSL certificate installation, renewal, and configuration.
  * Knowledge of CI/CD tools and pipelines (basic to intermediate level).
  * Experience installing and managing endpoint security applications, simulators, and log/event generation from various devices and applications.
  * Experience with server and service deployment on VMware, AWS, GCP, or Azure.
  * Ability to act as a Subject Matter Expert (SME) for supported applications and infrastructure components.
